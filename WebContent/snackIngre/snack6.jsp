...
<br>
   ...
   <tr align="left">
      ...
      한 입 크기의 간식으로 훈련용으로 가볍게 주기 좋으며 합성 첨가물을 일절 첨가하지 않아 안심하고 급여 가능합니다. <br>
      원재료 역시 단백질은 청정 국가인 호주산 화이트 피쉬와 닭을 사용하며 채소는 농장에서 직접 제배한 시금치와 엄선된 켈프를 사용합니다. <br>
      </font></td>
   </tr>
</table>
<br>
